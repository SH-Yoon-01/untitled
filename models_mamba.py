...
def create_block(
    ...
    # import ipdb; ipdb.set_trace()
    mixer_cls = partial(Mamba, expand=expand, headdim=headdim, layer_idx=layer_idx, bimamba_type=bimamba_type, if_divide_out=if_divide_out, init_layer_scale=init_layer_scale, **ssm_cfg, **factory_kwargs)
    norm_cls = partial(
